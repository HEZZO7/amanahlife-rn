/**
 * Bundled Surah metadata (Arabic name, English name/translation, ayah count,
 * revelation type) for all 114 surahs - sourced from api.alquran.cloud's
 * /v1/surah endpoint, fetched once and committed here so the Quran index
 * screen renders instantly with zero network dependency. Static reference
 * data (surah names/counts never change), same convention as ADHKAR_DATA/
 * PRESETS/DUAS elsewhere in the app.
 */
...
export const QURAN_SURAH_LIST: QuranSurahMeta[] = [
  {
    "number": 1,
